...
const DATA = {
 ...
 persons: [
  ...
  { id:"sibling",     icon:"🫂", label:"My Sibling",           sub:"Brother, sister, or twin" },
  { id:"pet",         icon:"🐾", label:"My Pet",               sub:"Dog, cat, horse, or any beloved animal" },
  { id:"colleague",   icon:"💼", label:"A Colleague / Boss",   sub:"Work friend, mentor, or the whole team" },
  { id:"ex",          icon:"💔", label:"My Ex",                sub:"Closure, nostalgia, or one last thing to say" },
